    ...
    return (
        <>
            <Helmet>
			  ...
			  <meta name="description" content="UX Courses - Learn UX/UI Design with our 25-Week Diploma course. Online-Classes with live sessions from industry professionals. Launch your career as a UX designer, Apply now."/>
			  
			  <meta name="keywords" content="ui ux design course, ux courses online, ux design course, ux ui course, online ux course, user experience design courses, best ui ux design course, ui ux courses, ui design courses, user interface design courses, AND Academy"/>
...
<section className="banner">
	<div className="container-fluid">
		<div className="row first_row">
			...
			<lottie-player class="main_animation" id="motion_dv" src="images/User/landing_motion.json" background="transparent"   speed="1" pause="1000"  style={{"width":"100%","height":"100%","maxWidth":"270px","marginLeft":"auto","marginRight":"auto"}}   loop autoplay></lottie-player>
		    </div>
            <div className="col-md-2 bord-right center_sec no_padd_col center_sec_image">
                        <div className="home_center_img">
                            <div style={{"background":"url(images/User/home-center-im.jpg) no-repeat","backgroundSize":"cover","height":"100%"}}></div>	
                        </div>
                
                    <div className="text-div text-div-cent">
                                <p>Create mobile apps, websites and other digital products that connect with users in relevant and meaningful ways.</p>
        ...
        PLACEMENT SUPPORT</h2>
            ...
            <div className="col-md-5 mob_padding_no desk_padding_right_0 right_last_sec">
                    <div className="row">
                        ...
                        <div className="col-md-7">
                            <div className="home_right_img">
                                <div style={{"background":"url(images/User/21x.webp) no-repeat","backgroundSize":"cover","height":"100%","backgroundPosition":"center center"}}></div>
                            </div>
                        </div>
                    </div>
					<Consumer>
                    ...
                    <lottie-player class="download_broch_icon" id="motion_dv" src="images/User/arrow_landingpage.json" background="transparent"   speed="1" pause="1000"  style={{"width":"50px","height":"50px","position":"relative","top":"4px"}}  loop  autoplay></lottie-player>
                    </a>
...
networking</h3>
				...
				<div className="classes_div mob_img">
					<img className="" src="images/User/course-img-3.jpg" alt="" />
				</div>
			</div>
			<div className="col-md-3">
				<div className="first_course_img">
					<div style={{"background":"url(images/User/course-imag-1.jpg) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
				</div>
				
			</div>
			<div className="col-md-3">
				<div className="last_course_img">
					<div style={{"background":"url(images/User/course-imag-2.jpg) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
				</div>
...
<section className="future_sec mob_hid">
	<div className="container-fluid">
		...
		<div style={{"background":"url(images/User/futuer-job-full-1.jpg) no-repeat","backgroundSize":"cover","height":"100%","width":"100%"}}></div>
		</div>
	</div>
	<div className="future_div">
		...
		<div style={{"background":"url(images/User/futuer-job-half-1.jpg) no-repeat","backgroundSize":"cover","height":"100%","width":"100%"}}></div>
		</div>
		<div className="lower_half">
	...
	<div className="future_div">
		<div className="all_full">
			<div style={{"background":"url(images/User/futuer-job-full-2.jpg) no-repeat","backgroundSize":"cover","height":"100%","width":"100%"}}></div>
	...
	<div className="future_div last_future_div">
		<div className="upper_half">
			<div style={{"background":"url(images/User/futuer-job-full-landscap.jpg) no-repeat","backgroundSize":"cover","height":"100%","width":"100%"}}></div>
		</div>
		<div className="lower_half">
	...
	<div className="container-fluid">
		<div className="row">
			<div className="col-md-12">
				...
				<p>Create seamless user experiences by combining the knowledge of research, product development, strategy and design, to create mobile apps, websites, and other digital products.  </p>
		...
		<div className="row number_row">
			...
			<div className="row">
				...
				<Consumer>
					...
					<lottie-player class="download_broch_icon yellow" id="motion_dv" src="images/User/arrow_landingpage-red.json"  background="transparent"   speed="1" pause="1000"  style={{"width":"60px","height":"60px","position":"relative","top":"7px"}}  loop  autoplay></lottie-player>
					</a>
...
Zeplin</p>
			...
			<div className="col-md-3">
				<div style={{"background":"url(images/User/software-training.jpg) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
			</div>
		</div>
	</div>
</section>
	...
	<div className="container-fluid">
		<div className="row">
			<div className="col-md-6">
				...
				<p>The programme is designed for people with a passion for learning to design functional and engaging products. If you have prior exposure in design, that’s even better. </p>
			</div>
			<div className="col-md-6">
				...
				<a href="https://apply.andacademy.com/" target="_blank"><img className="tick_img" height="44" src="images/User/tick_icon_black.svg" alt="" /></a>
			</div>
			<div className="eligiblity_img">
			<div className="cent_back_img" style={{"background":"url(images/User/no-prior-img.jpg) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
...
<Consumer>
				...
				<lottie-player class="download_broch_icon yellow" id="motion_dv" src="images/User/arrow_landingpage-yellow.json"  background="transparent"   speed="1" pause="1000"  style={{"width":"60px","height":"60px","position":"relative","top":"7px"}}  loop  autoplay></lottie-player>
				</a>
...
<section className="digital-brand-sec yellow_sec">
	<div className="container-fluid">
		<div className="row">
			<div className="col-md-8">
				<a className="anchor_whole" href="motion-graphics-animation-course"><span></span>
				...
				<img className="tick_img" height="44" src="images/User/tick_icon.svg" alt="" />
				</p>
			...
			<div className="col-md-4">
				<div className="cent_back_img" style={{"background":"url(images/User/motion_below_box.webp) no-repeat","backgroundSize":"cover","height":"100%"}}>
				</div>
			</div>
		</div>
	</div>
			...
			<div className="container-fluid">
				<div className="row">
					<div className="col-md-4">
					<div className="cent_back_img" style={{"background":"url(images/User/graphic_below_box.webp) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
					...
					<div className="col-md-8 yellow_div">
						...
						<p>Master the fundamentals of graphic design, from colour theory, composition and typography to creative applications and design processes.
							...
							<img className="tick_img" height="44" src="images/User/tick_icon_red.svg" alt="" />
						</p>
						</a>
					</div>
				</div>
	...
	<div className="container-fluid">
		<div className="row">
			...
			<div className="col-md-8">
				...
				<img className="tick_img" height="44" src="images/User/tick_icon_red.svg" alt="" /></p>
				</a>
				
			</div>
			<div className="col-md-4">
				<div className="cent_back_img"  style={{"background":"url(images/User/digital_below_box.webp) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
			</div>
			</div>
			</div>
			</section>
	...
	<div className="container-fluid">
		<div className="row">
			<div className="col-md-4">
				<div className="cent_back_img"  style={{"background":"url(images/User/interior_below_box.jpg) no-repeat","backgroundSize":"cover","height":"100%", "backgroundPosition" : "center"}}></div>
			</div>
			<div className="col-md-8 blue_div">
				...
				<img className="tick_img" height="44" src="images/User/tick_icon_black.svg" alt="" /></p>
				</a>
