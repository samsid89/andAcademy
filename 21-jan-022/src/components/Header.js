        ...
        return(
            ...
            <Container fluid>
                <Row>
                    ...
                    <div className='logo'>
                        <a className="logo-desktop" href="/"><img src="./images/logo-vertical.svg" alt="And Academy" /></a>
                        <a className="logo-mobile" href="/"><img src="./images/logo.svg" alt="And Academy" /></a>
                    </div>
                    ...
                    <button onClick={remove} className="toggle_button"><span className="top_line"></span><span className="bottom_line"></span></button>
                        ...
                        <Nav.Link className="last_links" href="https://apply.andacademy.com/"  target={'_blank'} eventKey="link-2">APPLY NOW <img src="./images/arrow_up.svg"/></Nav.Link>
                    </Nav>
                    </div>
                    </Col>
                    <Col md={8}>
