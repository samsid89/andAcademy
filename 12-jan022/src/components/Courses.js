                ...
                <Row className="courses_below">
                    ...
                    <Accordion>
                        <Accordion.Item eventKey="0">
                            ...
                            <br />
                            Intensive 1-Year industry integrated programme with a placement guarantee.  It offers you the most comprehensive syllabus from basics to industry-ready specialisation over two terms. <br />
                            <div class="full_dv">
                                ...
                                <div className="numb">TERM  2:</div>
                                    <div className="txt">
                                    In the second term of 25-weeks, you will specialize in a design field with our cohort-based interactive online classes alongside an industry internship, preparing you for the real world. <br />
                            ...
                            <div className="apply_div">
                                ...
                                <div className="tick">
                                 Know More   <img src="./images/tick_icon.svg" alt="" />
                                </div>
                            </div>
                        ...
                        <Accordion.Item className="blue" eventKey="1">
                            ...
                            If you have a flair for spaces, turn your imagination into reality by learning how to plan, conceptualize and execute interior spaces. The art of creating exceptional interiors is a fine balance between aesthetics and functional design. Start your own design business or simply pursue your passion.
                                <div className="apply_div">
                                    ...
                                    <div className="tick">
                                    Know More   <img src="./images/tick_icon_black.svg" alt="" />
                                    </div>
                                </div>
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item className="white" eventKey="2">
                            ...
                            <div className="apply_div">
                                ...
                                <div className="tick">
                                 Know More   <img src="./images/tick_icon_red.svg" alt="" />
                                </div>
                            </div>
                            </Accordion.Body>
                        </Accordion.Item>
