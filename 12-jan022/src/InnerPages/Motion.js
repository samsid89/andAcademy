...
function Motion(props) {
    ...
    return (
        ...
        <Helmet>
              ...
              <title>Motion | AND Academy</title>
              </Helmet>
                ...
                <div className="container-fluid">
                    <div className="row">
						...
						<Consumer>
                        {
                            ...
                            ({data,handlecheck})=>(
								<a className="download_broch_1" ><span onClick={()=>{handlecheck(true)}} className="mob_down">DOWNLOAD </span>BROCHURE 
            ...
            <section className="banner">
                <div className="container-fluid">
                    <div className="row first_row">
                        ...
                        <lottie-player id="motion_dv" src="images/Motion/landing_motion.json" background="transparent"   speed="1" pause="1000"  style={{"width":"100%","height":"100%","maxWidth":"345px","marginLeft":"auto","marginRight":"auto"}}   loop autoplay></lottie-player>
	...
	<div className="container-fluid">
		<div className="row">
			...
			<div className="col-md-6">
				...
				<a href="#"><img className="tick_img" height="44" src="images/Motion/tick_icon_black.svg" alt="" /></a>
			</div>
...
<section className="digital-brand-sec black_sec">
	...
	<div className="container-fluid">
		<div className="row">
			<div className="col-md-4">
				<div className="cent_back_img"  style={{"background":"url(images/Motion/interior_below_box.jpg) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
			</div>
...
<div id="myModal" className="modal fade brochure_box" role="dialog">
  <div className="modal-dialog">

   
    <div className="modal-content">
	<button type="button" className="close" data-dismiss="modal"><img src="images/Motion/cross_popup.svg" alt="" /></button>
      <div className="container-fluid">
	   <div className="row">
		<div className="col-md-2">
			<img src="images/Motion/white-logo.svg" alt="" />
		</div>
		<div className="col-md-10"></div>
		<div className="col-md-2 bord_bottom_broch">
		</div>
		<div className="col-md-10 bord_bottom_broch">
			<form>
				...
				<div className="custom-select">
					<select>
						...
						<option>COMMUNICATION DESIGN : PG DIPLOMA</option>
						<option>MOTION GRAPHICS</option>
						<option>USER EXPERIENCE </option>
						<option>DIGITAL BRAND COMMUNICATION</option>
				...
				<div className="custom-select">
					<select>
						...
						<option>UG Student (Final Year)</option>
						<option>PG Student</option>
						<option>0 Year Work Experience</option>
						<option>1-2 Years Work Experience</option>
						<option>2-4 Years Work Experience</option>
						<option>4+ Years Work Experience</option>
					</select>
				</div>
