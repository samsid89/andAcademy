    ...
    return (
        <>
            <Helmet>
              ...
              <title>Graphic | AND Academy</title>
              </Helmet>
  ...
  <div class="container-fluid">
    <div class="row">
		...
		<div class="col-md-3">
			...
			<lottie-player class="download_broch_icon" id="motion_dv" src="images/Graphic/arrow_landingpage.json" background="transparent"   speed="1" pause="1000"  style={{"width":"30px","height":"30px","position":"relative","top":"4px"}}  loop  autoplay></lottie-player>
			</a>
		</div>
	</div>
	</div>
...
<section class="banner">
	<div class="container-fluid">
		<div class="row first_row">
			...
			<lottie-player id="motion_dv" src="images/Graphic/landing_motion.json" background="transparent"   speed="1" pause="1000"  style={{"width":"100%","height":"100%","maxWidth":"335px","marginLeft":"auto","marginRight":"auto"}}   loop autoplay></lottie-player>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<a href="#"><img class="tick_img" height="44" src="images/Graphic/tick_icon_black.svg" alt="" /></a>
			</div>
...
<section class="digital-brand-sec yellow_sec">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-4">
				<div class="cent_back_img"  style={{"background":"url(images/Graphic/interior_below_box.jpg) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
			</div>
