                    ...
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-md-3">
                                ...
                                <lottie-player class="download_broch_icon" id="motion_dv" src="images/User/arrow_landingpage.json" background="transparent"   speed="1" pause="1000"  style={{"width":"30px","height":"30px","position":"relative","top":"4px"}}  loop  autoplay></lottie-player>
                                </a>
                            </div>
                        </div>
                    </div>
...
<section className="banner">
	<div className="container-fluid">
		<div className="row first_row">
			...
			<lottie-player id="motion_dv" src="images/User/landing_motion.json" background="transparent"   speed="1" pause="1000"  style={{"width":"100%","height":"100%","maxWidth":"270px","marginLeft":"auto","marginRight":"auto"}}   loop autoplay></lottie-player>
		    </div>
	...
	<div className="container-fluid">
		<div className="row">
			...
			<div className="col-md-6">
				...
				<p>Apply for our 1 year PG Diploma program in Communications Design with specialisation in User Experience (UX/UI), Motion Graphics and Digital Brand Communication. Open to graduates from any field. </p>
				<a href="#"><img className="tick_img" height="44" src="images/User/tick_icon_black.svg" alt="" /></a>
			</div>
...
programme to pick ?</h2>
				...
				<lottie-player className="download_broch_icon yellow" id="motion_dv" src="images/User/arrow_landingpage-yellow.json"  background="transparent"   speed="1" pause="1000"  style={{"width":"60px","height":"60px","position":"relative","top":"7px"}}  loop  autoplay></lottie-player>
				</a>
			</div>
		</div>
	</div>
...
<section className="digital-brand-sec yellow_sec">
	...
	<div className="container-fluid">
		<div className="row">
			<div className="col-md-4">
				<div className="cent_back_img"  style={{"background":"url(images/User/interior_below_box.jpg) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
			</div>
