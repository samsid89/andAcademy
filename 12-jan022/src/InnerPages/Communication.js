    ...
    return (
        <>
            <Helmet>
              ...
              <title>Communication | AND Academy</title>
              </Helmet>
		...
		<div className="container-fluid">
			<div className="row">
				...
				<div className="col-md-3">	<a className="download_broch_1" data-toggle="modal" data-target="#myModal" href=""><span className="mob_down">DOWNLOAD </span>BROCHURE 
			<lottie-player class="download_broch_icon" id="motion_dv" src="images/Communication/arrow_landingpage.json" background="transparent"   speed="1" pause="1000"  style={{"width":"30px","height":"30px","position":"relative","top":"4px"}}  loop  autoplay></lottie-player>
			</a>
				</div>
			</div>
		</div>
...
Digital Brand Communication /<br /> Motion Graphic Design
				...
				<div className="col-md-4 mob_padding_no desk_padding_right_0 right_last_sec">
					...
					</div>	<a className="download_broch" data-toggle="modal" data-target="#myModal" href="">DOWNLOAD BROCHURE 
...
intense module followed by a 25-week online specialisation, integrated with a 6-month industry internship</p>
					</div>
...
In the second term, you will have the opportunity to do an industry internship alongside online evening classNamees in your chosen specialisation. Furthermore, you get trained in relevant industry-standard software and tools as well as develop a robust portfolio of advanced projects.</p>
	...
	<section  className="course-structure-title accordion_section">
		...
		<div className="row">
				<div className="col-md-12">
				<h3 className="mob_side_pad"><span>Semester 2</span>  Pick a Specialisation | 25 weeks | Online evening classNamees | Industry internship</h3>
				</div>
			...
			<div className="row">
				<div className="col-md-12">
					...
					<div className="row">
						<div className="col-md-12">	<a href="#" className="download_curri">DOWNLOAD CURRICULUM 
	...
	<section className="digital-brand-sec yellow_sec another_yellow_sec">
		<div className="container-fluid">
			<div className="row">
				<div className="col-md-8">	<a className="anchor_whole" href="#"><span></span>
	...
	<section className="digital-brand-sec blue_sec">
		<div className="container-fluid">
			<div className="row">
				...
				<div className="col-md-4">
					<div className="cent_back_img" style={{"background":"url(images/Communication/interior_below_box.jpg) no-repeat","backgroundSize":"cover","height":"100%"}}></div>
				</div>
			</div>
		</div>
	</section>
...
programme to pick ?</h2>
	...
	<footer>
		<div className="container-fluid">
			<div className="row">
				<div className="col-md-12">Copyright 2021 AND Academy | All Rights Reserved</div>
			</div>
		</div>
	</footer>
        ...
        document.addEventListener("DOMContentLoaded", function() { 
            ...
            var horizontalAccordions = $(".accordion.width");
				horizontalAccordions.each(function() {
					...
					setTimeout(()=>{bodies.width(bodies.eq(0).width());bodies.height(bodies.eq(0).height());},500)
