        ...
        return(
            ...
            <Container fluid>
                ...
                <Row className="accordion_row">
                    ...
                    <Col md={8}>
                    <Accordion>
                        <Accordion.Item className="" eventKey="0" data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="800">
                        ...
                        The PG Diploma in Communication Design is taught in a hybrid mode; Term 1 consists of 20 weeks of on campus teaching and Term 2 consists of 20 weeks of online, live teaching  (evenings - 2 hours x 3 days  a week) alongside a mandatory internship.<br /><br />

                        The Diploma courses are taught Online in the evening, 2 hours x 3 days  a week.  These are real-time, live, interactive, faculty led sessions.  <br /><br />
                        ...
                        <Accordion.Item className="" eventKey="1" data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="900">
                            ...
                            The PG Diploma in Communication Design comes with a job guarantee, which means that if you are not placed within six months of successful completion of the programme you will be entitled to a full fee refund.  This is subject to meeting the minimum attendance and academic requirements of the programme.*/}  
                            Placement support and assistance is provided to all participants. However, the Diploma program does not come with a job guarantee.
                            <br /><br />
                            ...
                            With a dedicated career services team and over 130+ corporate connects built over the years, there will be ample opportunities for AND Academy’s graduates to receive the support required to be placed successfully.

                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item className="" eventKey="2" data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="1000">
                            ...
                            - Appear for an online entrance test <br />
