            ...
            <Container fluid>
                <Row>
                    ...
                    <Col md={8}>
                        ...
                        <p data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="600">We make design learning simple right from the application. Here is the step by step process to apply for Design Courses at AND Academy.</p>
...
Offer Letter</p>
                    ...
                    <Col className="red" md={2}>
                        <div data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="1400">
                        <h4>04</h4>
                                            <p>Enroll in a <br />
programme <br />
& choose your <br />
