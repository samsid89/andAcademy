...
import { Col, Modal, Button, Container, Row, Form ,Image} from 'react-bootstrap';
...
function ModalPopup(props) {
  const [show, setShow] = useState(false);
      ...
      const [error, setError] = useState({name:"",email:"",course:"",experience:"",mobile:""});
      ...
      const [showImg, setImg] = useState(false);
       ...
       /* const options2 = [
        ...
        function getData() {
          ...
          axios.get("https://www.andacademy.com/and-academy-api/country_list.php").then(function (response) {
...
for (var i = 0; i < len; i++) {
  ...
  options2.push({
    value: "+"+data[i].phonecode, label: "+"+data[i].phonecode
    });
}
...
function handleSubmit(e)
      {
       ...
       if(isValid)
       {
        ...
        if(verified)
        {
          setMsg("")
          setErrorcls("")
          const data = {name:name,email:email,course:selecteCourse.value,experience:selecteExperience.value,mobile:mobile}
       
          axios.post('https://www.andacademy.com/and-academy-api/submitForm.php', data)
...

               {
                 ...
                 <Container fluid>
                   <Row>
                     ...
                     <Col md={10}><p className={`${'error_head'} ${errorcls }`}  style={{marginTop:"100px"}}>{msg}</p></Col>
                     ...
                     <Form onSubmit={handleSubmit}>
                       ...
                       <Form.Control type="email" placeholder="E-MAIL" name={email}  onChange={(e)=>{setEmail(e.target.value)}} />
                       ...
                       <div className="phone_div">
                         ...
                         <Form.Control name="mobile" className="telephone_inp" type="tel" placeholder="ENTER MOBILE NO." onChange={(e)=>{setMobile(e.target.value)}} maxLength={15} />
                       </div>
                       <ReCAPTCHA
  ...
  />
                 ...
                 :  <Container fluid><Image src="./images/hello_confirmation_img.png" style={{width:"100%"}} /></Container>
