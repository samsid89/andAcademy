            ...
            <Container fluid>
                ...
                <Row className="andacademy_row">
                    ...
                    <Col md={2}>
                        ...
                        <img  data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="700" src="../images/excel.webp" alt="" />
                    </Col>
                    <Col md={2}>
                        {/*div className="andacademy_part">
                        ...
                        <img  data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="800" src="../images/learn.webp" alt="" />
                    </Col>
                    <Col className="desk_hidden" md={2}>
                    <div className="andacademy_part">
                        <div className="part_inner part_inner_5"  data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="850">
                    ...
                    <Col className="desk_hidden" md={2}>
                    <div className="andacademy_part">
                        <div  data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="900" style={{ backgroundImage: 'url(' + Image + ')', backgroundSize: 'cover', backgroundPosition: 'center' }}  className="part_inner part_inner_5">
                    ...
                    <Col md={2}>
                        ...
                        <img  data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="900" src="../images/build.webp" alt="" />
                    </Col>
                    <Col md={2}>
                        {/*<div className="andacademy_part">
                        <div className="red_background"></div>
                        ...
                        <img  data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="1000" src="../images/work.webp" alt="" />
                    </Col>
                    <Col className="mob_hidden" md={2}>
                    <div  data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="1200" className="andacademy_part">
