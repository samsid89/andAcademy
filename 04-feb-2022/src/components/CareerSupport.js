        ...
        return(
            ...
            <Container fluid>
                ...
                <Row className="number_row first_numb_row">
                    ...
                    <Col md={2}>
                    <h4 data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="850">
                        02
                        </h4>
                        <p data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="850">
                    ...
                    <Col md={2}>
                        <div  data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="700" className="back_img">
                ...
                <Row className="number_row second_numb_row">
                    ...
                    <Col md={2} data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="900">
                        <div style={{ backgroundImage: 'url(' + Image_2 + ')', backgroundSize: 'cover', backgroundPosition: 'center' }}  className="back_image_sq"></div>
                        
                    </Col>
                    <Col md={2}>
                    <h4 data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="950">
                        03
                        </h4>
                        <p data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="950">
                    ...
                    <Col md={2}>
                    <h4 data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="980">
                        04
                        </h4>
                        <p data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="980">
                ...
                <Row className="number_row third_numb_row">
                    ...
                    <Col md={2}>
                    <h4 data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="1000">
                        05
                        </h4>
                    ...
                    <Col md={2}>
                    <h4 data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="1050">
                        06
                        </h4>
                        <p data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="1050">
                    ...
                    <Col className="desk_hidden" md={2}>
                        <div data-aos="fade-up"  data-aos-duration="1500" data-aos-delay="1080" style={{ backgroundImage: 'url(' + Image + ')', backgroundSize: 'cover', backgroundPosition: 'center' }}  className="back_image_sq"></div>
