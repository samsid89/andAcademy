    ...
    return (
        <>
            <Helmet>
			  ...
			  <meta name="description" content="Digital Marketing Courses - Learn Digital Brand Communication & Digital Marketing with our 25-week Diploma course. Online-Classes with live sessions from industry professionals, Apply now."/>
			  
			  <meta name="keywords" content="digital brand communication course, digital brand communication diploma, digital marketing and communication diploma, online digital marketing and communication course, online digital marketing course, digital marketing diploma, digital brand communication course, AND Academy"/>
              <title>Digital Marketing & Digital Brand Communication Course | AND Academy</title>
              </Helmet>
...
<section className="banner">
	<div className="container-fluid">
		<div className="row first_row">
			...
			<lottie-player class="main_animation" id="motion_dv" src="images/Digital/landing_motion.json" background="transparent"   speed="1" pause="1000"  style={{"width":"100%","height":"100%","maxWidth":"305px","marginLeft":"auto","marginRight":"auto"}}   loop autoplay></lottie-player>
...
<section className="future_sec mob_hid">
	...
	<div className="future_div">
		...
		<div className="lower_half">
		<div style={{"background":"url(images/Digital/61x.jpg) no-repeat","backgroundSize":"cover","height":"100%","width":"100%", "backgroundPosition" : "center"}}></div>
		</div>
	</div>
	<div className="future_div">
		<div className="upper_half">
...
Hootsuite
			...
			<div className="col-md-3">
				<div style={{"background":"url(images/Digital/software-training.jpg) no-repeat","backgroundSize":"cover","height":"100%", "backgroundPosition" : "center"}}></div>
			</div>
		</div>
	</div>
</section>
	...
	<div className="container-fluid">
		<div className="row">
			...
			<div className="col-md-6">
				...
				<a href="https://apply.andacademy.com/" target="_blank"><img className="tick_img" height="44" src="images/Digital/tick_icon_black.svg" alt="" /></a>
			</div>
...
<section className="digital-brand-sec yellow_sec">
		...
		<div className="row">
			...
			<div className="container-fluid">
				<div className="row">
					...
					<div className="col-md-8">
						<a className="anchor_whole" href="user-experience-design-course">
						<h6>Intermediate Level </h6>
	...
	<div className="container-fluid">
		<div className="row">
			<div className="col-md-4">
				<div className="cent_back_img"  style={{"background":"url(images/Digital/interior_below_box.jpg) no-repeat","backgroundSize":"cover","height":"100%", "backgroundPosition" : "center"}}></div>
			</div>
